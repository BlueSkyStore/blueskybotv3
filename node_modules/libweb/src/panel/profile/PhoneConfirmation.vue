<template>
    <b-alert show :variant="variant">
        <w-verify-code
            ...
            type="phone"
            :phone="phone"
            :request-url="urlParser.localizeUrl('/api/usermanager/Profile/RequestCodeForConfirmingPhone').toRelative()"
            :verify-url="urlParser.localizeUrl('/api/usermanager/Profile/VerifyCodeForConfirmingPhone').toRelative()"
            @done="verified"
        ></w-verify-code>
        {{message}}
        <div v-show="!value">
    ...
    methods: {
        ...
        async confirm() {
            try {
                ...
                await this.$api.post('/api/usermanager/Profile/ConfirmPhone', {
                    password: this.password,
                    phoneNational: this.phone.phone,
