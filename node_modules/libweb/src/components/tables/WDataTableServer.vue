                ...
                >
                    <slot :name="`${c.field}_header`" v-bind:col="c">
                        <div
                            ...
                            @click="changeSort(c)"
                        >
                            <div class="flex-grow-1" style="vertical-align: middle">
                                <slot
                            ...
                            <div class="w-auto" style="vertical-align: middle">
                                <span
                                    class="mdi mdi-18px"
                                    style="width: 18px"
                                ...
                                ></span>
                                <span style="width: 8px">{{getSortNumber(c)}}</span>
                            </div>
                        </div>
                        <div v-else>
                            <slot
...
<script>
import loc from './WDataTableServer.i18n.json';
...
export default {
    ...
    props: {
        ...
        // object of type {field: '', asc: null or true or false}
        defaultSort: {
            type: Object,
            default() {
                return null;
    ...
    methods: {
        ...
        updateRow(row, index) {
            return this.$refs.table.updateRow(row, index);
        },
        addRow(row) {
            return this.$refs.table.addRow(row);
        },
        deleteRow(index) {
            return this.$refs.table.deleteRow(index);
        },
        //private methods.................................................
        provide(eventArgs) {
            ...
            if (page <= 0) {
                this.toastError(this.$t('CannotShowAllRows'));
                response.rows = [];
                response.totalRows = 0;
                callback(eventArgs);
            } else {
                this.$emit('data-provider', {
                    search: search,
                    page: page,
                    rowsPerPage: pageLength,
                    sorts: this.getSorts(),
                    callback: (rows, totalRows) => {
                        response.rows = rows === undefined || rows === null ? [] : rows;
                        response.totalRows = totalRows === undefined || totalRows === null ? 0 : totalRows;
                        callback(eventArgs);
                    }
                });
            }
        ...
        updateColumnsFromCols() {
            ...
            this.cols.forEach(a => {
                ...
                if (!(a.visible === false || a.sortable === false)) {
                    ...
                    if (ds !== undefined && ds !== null && ds.field !== undefined && ds.field !== null &&
                        ds.field.length > 0 && ds.asc !== undefined && ds.asc !== null &&
                        ds.field === this.getSortField(a)) {
