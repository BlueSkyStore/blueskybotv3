...
.tree-arrow.has-child:after {
    border-bottom-color: $w-tree-anchor-border-color !important;
    border-right-color: $w-tree-anchor-border-color !important;
}

.tree-arrow.has-child.rtl:after {
    border-top-color: $w-tree-anchor-border-color !important;
    border-left-color: $w-tree-anchor-border-color !important;
}